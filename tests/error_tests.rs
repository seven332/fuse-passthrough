...
fn test_read_nonexistent_file() {
    ...
    assert!(
        result.is_err(),
        "Expected error when opening nonexistent file"
    );
...
fn test_delete_nonexistent_file() {
    ...
    assert!(
        result.is_err(),
        "Expected error when deleting nonexistent file"
    );
...
fn test_delete_nonexistent_directory() {
    ...
    assert!(
        result.is_err(),
        "Expected error when deleting nonexistent directory"
    );
...
fn test_create_file_in_nonexistent_directory() {
    ...
    assert!(
        result.is_err(),
        "Expected error when creating file in nonexistent directory"
    );
...
fn test_rename_nonexistent_file() {
    ...
    assert!(
        result.is_err(),
        "Expected error when renaming nonexistent file"
    );
...
fn test_read_directory_as_file() {
    ...
    assert!(
        result.is_err(),
        "Expected error when reading directory as file"
    );
}
...
fn test_create_directory_that_exists() {
    ...
    assert!(
        result.is_err(),
        "Expected error when creating existing directory"
    );
...
fn test_read_symlink_to_nonexistent_target() {
    ...
    assert!(
        result.is_err(),
        "Expected error when reading through broken symlink"
    );
...
fn test_getattr_nonexistent_file() {
    ...
    assert!(
        result.is_err(),
        "Expected error for nonexistent file metadata"
    );
